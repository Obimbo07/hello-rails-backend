...
**[Hello-rails-backend]** is a project that hold the server side code for a hello application. The application displays Greetings data from this rails application.
Here is a link to the frontend application. [FrontEnd](https://github.com/Obimbo07/hello-rails-frontend/tree/feature/app-setup).
...
```sh
  ...
  git clone git@github.com:obimbo07/hello-rails-backend.git
```
-
